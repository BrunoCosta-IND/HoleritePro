...
-- 9. VERIFICAR DADOS ATUAIS (SEM MODIFICAR)
SELECT 
    'DADOS ATUAIS (SEM MODIFICAR):' as info,
    id,
    cpf,
    mes,
    ano,
...
BEGIN
    ...
    RAISE NOTICE '✅ Nenhum documento foi assinado';
    RAISE NOTICE 'Agora teste a assinatura no sistema!';
